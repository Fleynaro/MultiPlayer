...
// загрузка бинарника в память для анализа (параллельно юзать прогу CFF Explorer!)
...
int main()
{
	...
	// еще одна сигнатура, которая всегда равна PE\x0\x0
