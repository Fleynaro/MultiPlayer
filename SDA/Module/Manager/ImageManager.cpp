...
ImageDecorator* CE::ImageManager::createImage(AddressSpace* addressSpace, ImageDecorator::IMAGE_TYPE type, Symbol::SymbolTable* globalSymbolTable, Symbol::SymbolTable* funcBodySymbolTable, Symbol::SymbolTable* vfuncCallSymbolTable, Decompiler::ImagePCodeGraph* imagePCodeGraph, const std::string& name, const std::string& comment, bool generateId) {
	auto imageDec = new ImageDecorator(this, addressSpace, type, globalSymbolTable, funcBodySymbolTable, vfuncCallSymbolTable, imagePCodeGraph, name, comment);
...
ImageDecorator* CE::ImageManager::createImage(AddressSpace* addressSpace, ImageDecorator::IMAGE_TYPE type, const std::string& name, const std::string& comment, bool generateId) {
	...
	return createImage(addressSpace, type, globalSymbolTable, funcBodySymbolTable, vfuncCallSymbolTable, imagePCodeGraph, name, comment, generateId);
}
