...
public class SDataFullSyncPacket implements org.apache.thrift.TBase<SDataFullSyncPacket, SDataFullSyncPacket._Fields>, java.io.Serializable, Cloneable, Comparable<SDataFullSyncPacket> {
  ...
  private static final org.apache.thrift.protocol.TField REMOVED_DATATYPES_FIELD_DESC = new org.apache.thrift.protocol.TField("removed_datatypes", org.apache.thrift.protocol.TType.LIST, (short)7);
  private static final org.apache.thrift.protocol.TField REMOVED_FUNCTIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("removed_functions", org.apache.thrift.protocol.TType.LIST, (short)8);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    REMOVED_DATATYPES((short)7, "removed_datatypes"),
    REMOVED_FUNCTIONS((short)8, "removed_functions");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 6: // FUNCTIONS
          return FUNCTIONS;
        case 7: // REMOVED_DATATYPES
          return REMOVED_DATATYPES;
        case 8: // REMOVED_FUNCTIONS
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.removed_datatypes = new java.util.ArrayList<java.lang.Long>(_list26.size);
                long _elem27;
                for (int _i28 = 0; _i28 < _list26.size; ++_i28)
                {
                  _elem27 = iprot.readI64();
                  struct.removed_datatypes.add(_elem27);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.removed_functions = new java.util.ArrayList<java.lang.Long>(_list29.size);
                long _elem30;
                for (int _i31 = 0; _i31 < _list29.size; ++_i31)
                {
                  _elem30 = iprot.readI64();
                  struct.removed_functions.add(_elem30);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SDataFullSyncPacket struct) throws org.apache.thrift.TException {
      ...
      if (struct.typedefs != null) {
        oprot.writeFieldBegin(TYPEDEFS_FIELD_DESC);
        {
          ...
          for (sda.ghidra.datatype.SDataTypeTypedef _iter32 : struct.typedefs)
          {
            _iter32.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.classes != null) {
        oprot.writeFieldBegin(CLASSES_FIELD_DESC);
        {
          ...
          for (sda.ghidra.datatype.SDataTypeClass _iter33 : struct.classes)
          {
            _iter33.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.structures != null) {
        oprot.writeFieldBegin(STRUCTURES_FIELD_DESC);
        {
          ...
          for (sda.ghidra.datatype.SDataTypeStructure _iter34 : struct.structures)
          {
            _iter34.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.enums != null) {
        oprot.writeFieldBegin(ENUMS_FIELD_DESC);
        {
          ...
          for (sda.ghidra.datatype.SDataTypeEnum _iter35 : struct.enums)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.signatures != null) {
        oprot.writeFieldBegin(SIGNATURES_FIELD_DESC);
        {
          ...
          for (sda.ghidra.datatype.SDataTypeSignature _iter36 : struct.signatures)
          {
            _iter36.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.functions != null) {
        oprot.writeFieldBegin(FUNCTIONS_FIELD_DESC);
        {
          ...
          for (sda.ghidra.function.SFunction _iter37 : struct.functions)
          {
            _iter37.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.removed_datatypes != null) {
        oprot.writeFieldBegin(REMOVED_DATATYPES_FIELD_DESC);
        {
          ...
          for (long _iter38 : struct.removed_datatypes)
          {
      ...
      if (struct.removed_functions != null) {
        oprot.writeFieldBegin(REMOVED_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (long _iter39 : struct.removed_functions)
          {
      ...
      if (struct.isSetTypedefs()) {
        {
          ...
          for (sda.ghidra.datatype.SDataTypeTypedef _iter40 : struct.typedefs)
          {
            _iter40.write(oprot);
          }
        }
      ...
      if (struct.isSetClasses()) {
        {
          ...
          for (sda.ghidra.datatype.SDataTypeClass _iter41 : struct.classes)
          {
            _iter41.write(oprot);
          }
        }
      ...
      if (struct.isSetStructures()) {
        {
          ...
          for (sda.ghidra.datatype.SDataTypeStructure _iter42 : struct.structures)
          {
            _iter42.write(oprot);
          }
        }
      ...
      if (struct.isSetEnums()) {
        {
          ...
          for (sda.ghidra.datatype.SDataTypeEnum _iter43 : struct.enums)
          {
            _iter43.write(oprot);
          }
        }
      ...
      if (struct.isSetSignatures()) {
        {
          ...
          for (sda.ghidra.datatype.SDataTypeSignature _iter44 : struct.signatures)
          {
            _iter44.write(oprot);
          }
        }
      ...
      if (struct.isSetFunctions()) {
        {
          ...
          for (sda.ghidra.function.SFunction _iter45 : struct.functions)
          {
            _iter45.write(oprot);
          }
        }
      ...
      if (struct.isSetRemoved_datatypes()) {
        {
          ...
          for (long _iter46 : struct.removed_datatypes)
          {
      ...
      if (struct.isSetRemoved_functions()) {
        {
          ...
          for (long _iter47 : struct.removed_functions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.typedefs = new java.util.ArrayList<sda.ghidra.datatype.SDataTypeTypedef>(_list48.size);
          @org.apache.thrift.annotation.Nullable sda.ghidra.datatype.SDataTypeTypedef _elem49;
          for (int _i50 = 0; _i50 < _list48.size; ++_i50)
          {
            _elem49 = new sda.ghidra.datatype.SDataTypeTypedef();
            _elem49.read(iprot);
            struct.typedefs.add(_elem49);
          }
        }
        struct.setTypedefsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.classes = new java.util.ArrayList<sda.ghidra.datatype.SDataTypeClass>(_list51.size);
          @org.apache.thrift.annotation.Nullable sda.ghidra.datatype.SDataTypeClass _elem52;
          for (int _i53 = 0; _i53 < _list51.size; ++_i53)
          {
            _elem52 = new sda.ghidra.datatype.SDataTypeClass();
            _elem52.read(iprot);
            struct.classes.add(_elem52);
          }
        }
        struct.setClassesIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.structures = new java.util.ArrayList<sda.ghidra.datatype.SDataTypeStructure>(_list54.size);
          @org.apache.thrift.annotation.Nullable sda.ghidra.datatype.SDataTypeStructure _elem55;
          for (int _i56 = 0; _i56 < _list54.size; ++_i56)
          {
            _elem55 = new sda.ghidra.datatype.SDataTypeStructure();
            _elem55.read(iprot);
            struct.structures.add(_elem55);
          }
        }
        struct.setStructuresIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.enums = new java.util.ArrayList<sda.ghidra.datatype.SDataTypeEnum>(_list57.size);
          @org.apache.thrift.annotation.Nullable sda.ghidra.datatype.SDataTypeEnum _elem58;
          for (int _i59 = 0; _i59 < _list57.size; ++_i59)
          {
            _elem58 = new sda.ghidra.datatype.SDataTypeEnum();
            _elem58.read(iprot);
            struct.enums.add(_elem58);
          }
        }
        struct.setEnumsIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.signatures = new java.util.ArrayList<sda.ghidra.datatype.SDataTypeSignature>(_list60.size);
          @org.apache.thrift.annotation.Nullable sda.ghidra.datatype.SDataTypeSignature _elem61;
          for (int _i62 = 0; _i62 < _list60.size; ++_i62)
          {
            _elem61 = new sda.ghidra.datatype.SDataTypeSignature();
            _elem61.read(iprot);
            struct.signatures.add(_elem61);
          }
        }
        struct.setSignaturesIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.functions = new java.util.ArrayList<sda.ghidra.function.SFunction>(_list63.size);
          @org.apache.thrift.annotation.Nullable sda.ghidra.function.SFunction _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = new sda.ghidra.function.SFunction();
            _elem64.read(iprot);
            struct.functions.add(_elem64);
          }
        }
        struct.setFunctionsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.removed_datatypes = new java.util.ArrayList<java.lang.Long>(_list66.size);
          long _elem67;
          for (int _i68 = 0; _i68 < _list66.size; ++_i68)
          {
            _elem67 = iprot.readI64();
            struct.removed_datatypes.add(_elem67);
          }
        }
        struct.setRemoved_datatypesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.removed_functions = new java.util.ArrayList<java.lang.Long>(_list69.size);
          long _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = iprot.readI64();
            struct.removed_functions.add(_elem70);
          }
        }
        struct.setRemoved_functionsIsSet(true);
      }
