...
void CE::Decompiler::test() {
	...
	*/
	...
	//evklid algorithm
	byte sample16[] = { 0x83, 0xF8, 0x00, 0x7D, 0x02, 0xF7, 0xD8, 0x83, 0xFB, 0x00, 0x7D, 0x02, 0xF7, 0xDB, 0x39, 0xD8, 0x7D, 0x01, 0x93, 0x83, 0xFB, 0x00, 0x74, 0x04, 0x29, 0xD8, 0xEB, 0xF2, 0x89, 0x04, 0x24, 0x89, 0x1C, 0x24 };


	void* addr = sample15; //&func22;
	int size = sizeof(sample15); //calculateFunctionSize2((byte*)addr);
